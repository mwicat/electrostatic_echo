...
- `The Effect of Temperature, Lecithin Content, Voltage, Resistivity, Viscosity, and Surface Tension on Droplets/cm² During Electrostatic Spraying of Oil, Thesis, 2012, Didem Peren Aykas <https://etd.ohiolink.edu/acprod/odb_etd/ws/send_file/send?accession=osu1330588156&disposition=inline>`__
...
.. list-table:: Oil comparison
   ...
   * - Chemical name
     ...
     - Conductivity
     - Adsorption to oxide
   * - Pentapropylene glycol n-butyl ether
     - UCON LB-65, PPG-5 buteth
     - Poor (only available in bulk)
     - Moderate
     - Excellent
   * - Tripropylene glycol butyl ether
     - TPGBE, PPG-3 buteth
     - Moderate (available mostly from chemical suppliers)
     - Moderate
     - Excellent
   * - Polypropylene glycol n-butyl ether
     - (Generic) Compressor PAG
...
.. molimage:: CCCCOC(CC)OC(C)COC(CC)OC(C)COC(CC)O
...
.. list-table:: Buy options for Tripropylene glycol n-butyl ether (TPGBE)
  ...
  * - Product
    ...
    - Price
    - Price per litre
  * - `Tri(propylene glycol) monobutyl ether <https://www.carlroth.com/en/en/a-to-z/tri%28propylene-glycol%29-monobutyl-ether/p/209n.1>`__
    - 1 l
    - Carl Roth
    - EU
    - €52.70
    - €52.70
  * - `Dodatek przeciw krystalizacji Black Arrow <https://www.kemetyl.pl/produkt/dieselskydd-dodatek-do-oleju-napedowego-black-arrow/dodatek-przeciw-krystalizacji-black-arrow-250ml/>`__
    - 250 ml
    - Black Arrow
    - PL
    - 40 PLN
...
.. molimage:: CCCCOC(CC)OC(C)COC(CC)O

Links:
- `Dow oxygenated solvents - "Glycol ethers" section <https://www.dow.com/documents/327/327-00001-01-dow-oxygenated-solvents-selection-guide.pdf?iframe=true>`__


Triethyl citrate (TEC)
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. list-table:: Buy options for Triethyl citrate (TEC)
  ...
  * - Product
    ...
    - Price
    - Price per litre
  * - `Triethyl citrate, 1 l, glass <https://www.carlroth.com/en/en/other-solvagreen-reagents/triethyl-citrate/p/33na.2>`__
    - 1 l
    - Carl Roth
    - EU
    - €42.90
    - €42.90
  * - `TEC Cytrynian trietylu <https://chwasciarnia.com.pl/pl/p/TEC-Cytrynian-trietylu/248#variantOptions=10:65>`__
    - 100 ml
    - Chwasciarnia
    - PL
    - 27.93 PLN
...
.. molimage:: CCOC(=O)CC(CC(=O)OCC)(C(=O)OCC)O

Triacetin
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. molimage:: CC(=O)OCC(COC(=O)C)OC(=O)C
